...
export function Logo() {
  return (
    <div
      className={
        "flex items-center space-x-2 select-none group grow-0 shrink-0"
      }
    >
      <Image
        alt="logo"
...
export function NotionLogo({ size }: { size?: number }) {
  return (
    <Image
      src={notionLogoImage}
      alt={"notion logo"}
...
export function LinearLogo({ size }: { size?: number }) {
  return (
    <Image
      src={linearLogoImage}
      alt={"linear logo"}
...
export function PineconeLogo({ size }: { size?: number }) {
  return (
    <Image
      src={pineconeLogoImage}
      alt={"pinecone logo"}
      priority
      draggable={false}
      className={"select-none"}
